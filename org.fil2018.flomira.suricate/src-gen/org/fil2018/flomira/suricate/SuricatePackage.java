...
public interface SuricatePackage extends EPackage
{
  ...
  /**
   * Returns the meta object for the containment reference '{@link org.fil2018.flomira.suricate.Methode#getPara <em>Para</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @return the meta object for the containment reference '<em>Para</em>'.
   * @see org.fil2018.flomira.suricate.Methode#getPara()
   * @see #getMethode()
   * @generated
   */
  EReference getMethode_Para();
  ...
  interface Literals
  {
     ...
     * @generated
     */
    EReference METHODE__PARA = eINSTANCE.getMethode_Para();
