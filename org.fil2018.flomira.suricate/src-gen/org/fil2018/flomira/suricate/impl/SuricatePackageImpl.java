...
public class SuricatePackageImpl extends EPackageImpl implements SuricatePackage
{
   ...
   * @generated
   */
  public EAttribute getIntLiteral_Name()
  {
   ...
   * @generated
   */
  public EAttribute getStringLiteral_Name()
  {
  ...
  public void createPackageContents()
  {
    ...
    createEAttribute(intLiteralEClass, INT_LITERAL__NAME);

    stringLiteralEClass = createEClass(STRING_LITERAL);
    createEAttribute(stringLiteralEClass, STRING_LITERAL__NAME);
  ...
  public void initializePackageContents()
  {
    ...
    intLiteralEClass.getESuperTypes().add(this.getObjet());
    stringLiteralEClass.getESuperTypes().add(this.getObjet());
    constructeurEClass.getESuperTypes().add(this.getObjet());
    operationEClass.getESuperTypes().add(this.getLigne());
    operationEClass.getESuperTypes().add(this.getObjet());
    ...
    initEAttribute(getIntLiteral_Name(), ecorePackage.getEInt(), "name", null, 0, 1, IntLiteral.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

    initEClass(stringLiteralEClass, StringLiteral.class, "StringLiteral", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
    initEAttribute(getStringLiteral_Name(), ecorePackage.getEString(), "name", null, 0, 1, StringLiteral.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
